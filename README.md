# Legitimate RAT - A legal and ethic RAT solution
...
**Free, legal, Open-Source Remote Administration Tool for Windows**

Legitimate RAT is a fast and light-weight remote administration tool coded in C#. The usage ranges from user support through day-to-day administrative work to employee monitoring. Providing high stability and an easy-to-use user interface, Quasar is the perfect remote administration solution for you.
...
* AI detection to prevent malicious use
* ... and many more!
